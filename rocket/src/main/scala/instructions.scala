...
object Instructions {
  ...
  def LBUM               = BitPat("b?????????????????000?????0001011")
  def LHUM               = BitPat("b?????????????????001?????0001011")
  def LWUM               = BitPat("b?????????????????010?????0001011")
  def LDUM               = BitPat("b?????????????????011?????0001011")
  def LBUUM              = BitPat("b?????????????????100?????0001011")
  def LHUUM              = BitPat("b?????????????????101?????0001011")
  def LWUUM              = BitPat("b?????????????????110?????0001011")
  ...
  def SBM                = BitPat("b?????????????????000?????0101011")
  def SHM                = BitPat("b?????????????????001?????0101011")
  def SWM                = BitPat("b?????????????????010?????0101011")
  def SDM                = BitPat("b?????????????????011?????0101011")
  ...
  def MMLL               = BitPat("b????????????????????000001011011")
  def MMGL               = BitPat("b????????????????????000011011011")
  def DRPUSH             = BitPat("b????????????????????000101011011")
  def DRPOP              = BitPat("b????????????????????000111011011")
...
object CSRs {
  ...
  val instret = 0xc02
  val stats = 0xc0
  val dr_next_base = 0xc1
  val dr_cur_base = 0xc2
  val dr_prev_base = 0xc3
  val dr_push = 0xc4
  val dr_pop = 0xc5
  val dr_stack_region_base = 0xc6
  val dr_cmd = 0xc7
  val dr_mmgl = 0xc8
  val dr_mmll = 0xc9
  val dr_stack_dbg_set = 0xca
  val dr_stack_dbg_get = 0xcb
  val dr_static_table_base = 0xcc
  val uarch0 = 0xcc0
  val uarch1 = 0xcc1
  val uarch2 = 0xcc2
  val uarch3 = 0xcc3
  ...
  val all = {
    ...
    res += dr_push
    res += dr_pop
    res += dr_stack_region_base
    res += dr_cmd
    res += dr_mmgl
    res += dr_mmll
    res += dr_stack_dbg_set
    res += dr_stack_dbg_get
    res += dr_static_table_base
    res += uarch0
    res += uarch1
    res += uarch2
    res += uarch3
