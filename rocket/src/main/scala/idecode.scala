...
object XDecode extends DecodeConstants
{
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    LBUM->      List(Y,    N,N,N,N,N,N,Y,A2_ZERO, A1_RS1, IMM_I, DW_XPR,FN_ADD,   Y,M_XRDUM,    MT_B, N,N,N,N,N,Y,CSR.N,N,N,N),
    LHUM->      List(Y,    N,N,N,N,N,N,Y,A2_ZERO, A1_RS1, IMM_I, DW_XPR,FN_ADD,   Y,M_XRDUM,    MT_H, N,N,N,N,N,Y,CSR.N,N,N,N),
    LWUM->      List(Y,    N,N,N,N,N,N,Y,A2_ZERO, A1_RS1, IMM_I, DW_XPR,FN_ADD,   Y,M_XRDUM,    MT_W, N,N,N,N,N,Y,CSR.N,N,N,N),
    LDUM->      List(xpr64,N,N,N,N,N,N,Y,A2_ZERO, A1_RS1, IMM_I, DW_XPR,FN_ADD,   Y,M_XRDUM,  MT_D, N,N,N,N,N,Y,CSR.N,N,N,N),
    LBUUM->     List(Y,    N,N,N,N,N,N,Y,A2_ZERO, A1_RS1, IMM_I, DW_XPR,FN_ADD,   Y,M_XRDUM,    MT_BU,N,N,N,N,N,Y,CSR.N,N,N,N),
    LHUUM->     List(Y,    N,N,N,N,N,N,Y,A2_ZERO, A1_RS1, IMM_I, DW_XPR,FN_ADD,   Y,M_XRDUM,    MT_HU,N,N,N,N,N,Y,CSR.N,N,N,N),
    LWUUM->     List(xpr64,N,N,N,N,N,N,Y,A2_ZERO, A1_RS1, IMM_I, DW_XPR,FN_ADD,   Y,M_XRDUM,    MT_WU,N,N,N,N,N,Y,CSR.N,N,N,N),
    ...
    SBM->       List(Y,    N,N,N,N,N,Y,Y,A2_ZERO, A1_RS1, IMM_S, DW_XPR,FN_ADD,   Y,M_XWRM,    MT_B, N,N,N,N,N,N,CSR.N,N,N,N),
    SHM->       List(Y,    N,N,N,N,N,Y,Y,A2_ZERO, A1_RS1, IMM_S, DW_XPR,FN_ADD,   Y,M_XWRM,    MT_H, N,N,N,N,N,N,CSR.N,N,N,N),
    SWM->       List(Y,    N,N,N,N,N,Y,Y,A2_ZERO, A1_RS1, IMM_S, DW_XPR,FN_ADD,   Y,M_XWRM,    MT_W, N,N,N,N,N,N,CSR.N,N,N,N),
    SDM->       List(xpr64,N,N,N,N,N,Y,Y,A2_ZERO, A1_RS1, IMM_S, DW_XPR,FN_ADD,   Y,M_XWRM,   MT_D, N,N,N,N,N,N,CSR.N,N,N,N),

    MMLL->      List(Y,    N,N,N,N,N,N,N,A2_IMM, A1_ZERO, IMM_U, DW_XPR,FN_ADD,   N,M_X,      MT_X, N,N,N,N,N,N,CSR.N,N,N,N),
    MMGL->      List(Y,    N,N,N,N,N,N,N,A2_IMM, A1_ZERO, IMM_U, DW_XPR,FN_ADD,   N,M_X,      MT_X, N,N,N,N,N,N,CSR.N,N,N,N),
    DRPUSH->    List(Y,    N,N,N,N,N,N,N,A2_IMM, A1_ZERO, IMM_U, DW_XPR,FN_ADD,   N,M_X,      MT_X, N,N,N,N,N,N,CSR.N,N,N,N),
    DRPOP->     List(Y,    N,N,N,N,N,N,N,A2_IMM, A1_ZERO, IMM_U, DW_XPR,FN_ADD,   N,M_X,      MT_X, N,N,N,N,N,N,CSR.N,N,N,N),
