...
class WithL1DSets128 extends Config(knobValues = {case "L1D_SETS" => 128})
class DataRandoCPPConfig extends DefaultL2CPPConfig
class DataRandoFPGAConfig extends Config(new WithL2Capacity256 ++ new WithL2Cache ++ new DefaultFPGAConfig)
